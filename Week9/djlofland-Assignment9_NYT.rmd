...
# drop rows with any missing dates.  Note: There are also nulls in the rating column for movies that didn't receive an official mpaa rating letter.  For these, I'll replace nulls with 'not rated'
data_df2 <- data_df %>% 
